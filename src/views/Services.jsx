          ...
          <div className="row gy-4">
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div className="service-item position-relative">
                ...
                <p>
                  Usted paga un precio justo directamente a una empresa 100% local, no tiene que ser
                  rico, elija entre viajes de lujo, económicos, de día completo o de noche, viajes fuera
                  de lo común, caminatas, ciclismo, observación de aves y más.
                </p>
            ...
            <div className="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <div className="service-item position-relative">
                ...
                <p>
                  Una visita guiada o una caminata por el camino inca a Machupicchu es una excelente
                  manera de vincularse con amigos o pasar un momento memorable con su familia. (hasta 16
                  personas en Cusco).
                </p>
        ...
        <div className="container" data-aos="fade-up">
          <div className="row gy-4">
            <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
              ...
              <p>
                Eius non minus autem soluta ut ui labore omnis quisquam corrupti autem odit voluptas quos
            ...
            <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
              ...
              <p>
                Ducimus ea quam et occaecati est. Temporibus in soluta labore voluptates aut. Et sit
                soluta non repellat sed quia dire plovers tradoria
              </p>
            ...
            <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
              ...
              <p>
                Velit eos error et dolor omnis voluptates nobis tenetur sed enim nihil vero qui suscipit
            ...
            <div className="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
              ...
              <p>
                Molestiae occaecati assumenda quia saepe nobis recusandae at dicta ducimus sequi numquam
        ...
        <div className="container" data-aos="fade-up">
          <div className="row justify-content-around gy-4">
            <div className="col-lg-5 d-flex flex-column justify-content-center">
              ...
              <p>
                Maxime quia dolorum alias perspiciatis. Earum voluptatem sint at non. Ducimus maxime
                minima iste magni sit praesentium assumenda minus. Amet rerum saepe tempora vero.
              </p>
      ...
      <section id="alt-services" className="alt-services">
        <div className="container" data-aos="fade-up">
          <div className="row justify-content-around gy-4">
            <div
              className="col-lg-6 img-bg"
              style={{ backgroundImage: `url("src/assets/img/golden/LOS\ UROS\ 4.jpg")` }}
              data-aos="zoom-in"
              data-aos-delay="100"
            ></div>
