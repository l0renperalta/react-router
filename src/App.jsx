      ...
      <section id="hero" className="hero">
        ...
        >
          <div
            ...
            style={{ backgroundImage: `url("/assets/img/golden/CHOQUEQUIRAO3.jpg")` }}
          ></div>
          <div
            className="carousel-item"
            style={{ backgroundImage: `url("/assets/img/golden/MACHUPICCHU 1.jpg")` }}
          ></div>
          <div
            className="carousel-item"
            style={{ backgroundImage: `url("/assets/img/golden/CUSCO 22.jpg")` }}
          ></div>
          <div
            className="carousel-item"
            style={{ backgroundImage: `url("/assets/img/golden/ISLA AMANTANI 70.jpg")` }}
          ></div>
          <div
            className="carousel-item"
            style={{ backgroundImage: `url("/assets/img/golden/ISLA DE LOS UROS MF 100.jpg")` }}
          ></div>
                ...
                <div className="card-item">
                  <div className="row">
                    <div className="col-xl-5">
                      <div
                        className="card-bg"
                        style={{ backgroundImage: `url("/assets/img/travel/services-1.jpg")` }}
                      ></div>
                    </div>
                ...
                <div className="card-item">
                  <div className="row">
                    <div className="col-xl-5">
                      <div
                        className="card-bg"
                        style={{ backgroundImage: `url("/assets/img/travel/services-2.jpg")` }}
                      ></div>
                    </div>
                    <div className="col-xl-7 d-flex align-items-center">
                      <div className="card-body">
                ...
                <div className="card-item">
                  <div className="row">
                    <div className="col-xl-5">
                      <div
                        className="card-bg"
                        style={{ backgroundImage: `url("/assets/img/travel/services-3.jpg")` }}
                      ></div>
                    </div>
                    <div className="col-xl-7 d-flex align-items-center">
                      <div className="card-body">
                ...
                <div className="card-item">
                  <div className="row">
                    <div className="col-xl-5">
                      <div
                        className="card-bg"
                        style={{ backgroundImage: `url("/assets/img/travel/services-4.jpg")` }}
                      ></div>
                    </div>
                    <div className="col-xl-7 d-flex align-items-center">
                      <div className="card-body">
            ...
            <div className="tab-content">
              ...
              <div className="tab-pane" id="tab-4">
                <div className="row">
                  ...
                  <div className="col-lg-6 order-1 order-lg-2 text-center">
                    <img
                      src="/assets/img/golden/ISLA DE LOS UROS 509.jpg"
                      alt=""
                      className="img-fluid"
                    />
                  </div>
